...
type ImportFixType = imports.ImportFixType

const (
	AddImport     = imports.AddImport
	DeleteImport  = imports.DeleteImport
	SetImportName = imports.SetImportName
)

type ImportFix = imports.ImportFix

// An ImportInfo represents a single import statement.
type ImportInfo = imports.ImportInfo
