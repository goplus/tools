...
import _ "golang.org/lsptests/assign/internal/secret" //@diag("\"golang.org/lsptests/assign/internal/secret\"", "compiler", "could not import golang.org/lsptests/assign/internal/secret \\(no required module provides package golang.org/lsptests/assign/internal/secret; to add it:\\n\\txgo get golang.org/lsptests/assign/internal/secret\\)", "error")
